...
function optionSelected(option: ComponentOption, config: RobotConfig): boolean {
  ...
  return config.perception[0] === option.id;
}
              ...
              <div className="flex items-start justify-between gap-3">
                ...
                {selected ? (
                  <motion.span
                    ...
                    className="inline-flex items-center gap-1 rounded-md bg-green-soft px-2 py-1 text-xs font-medium text-background"
                  >
                    <Check size={13} />
                    {t("ui.selected")}
                  </motion.span>
